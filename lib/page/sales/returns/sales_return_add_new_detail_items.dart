...
class SalesReturnAddNewDetailItems extends StatefulWidget {
  ...
  const SalesReturnAddNewDetailItems(
      {super.key,
        this.docEntry = '',
        this.lineNum = '',
        this.batch = '',
  ...
  @override
  _SalesReturnAddNewDetailItemsState createState() => _SalesReturnAddNewDetailItemsState();
}

class _SalesReturnAddNewDetailItemsState extends State<SalesReturnAddNewDetailItems> {
