...
class ArCreditmemoDetailItems extends StatefulWidget {
  ...
  @override
  _ArCreditmemoDetailItemsState createState() => _ArCreditmemoDetailItemsState();
}

class _ArCreditmemoDetailItemsState extends State<ArCreditmemoDetailItems> {
